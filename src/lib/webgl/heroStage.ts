...
const phaseTone: Record<HeroPhase, HeroStagePhaseTone> = {
  ...
  settle: { ambient: 0.14, rim: 0.36, fill: 0.22, accent: 0.12, floor: 0.24, object: 0.52, contour: 0.24, glint: 0.08 },
  copy: { ambient: 0.14, rim: 0.3, fill: 0.19, accent: 0.1, floor: 0.21, object: 0.49, contour: 0.18, glint: 0.04 },
  idle: { ambient: 0.145, rim: 0.29, fill: 0.19, accent: 0.08, floor: 0.21, object: 0.5, contour: 0.18, glint: 0.02 },
};
