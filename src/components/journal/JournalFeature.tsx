  ...
  return (
    <section className="section-divider py-20">
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        ...
        <article className="mt-5 overflow-hidden rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] lg:grid lg:grid-cols-[1.2fr_1fr]">
          <div className="relative aspect-[16/10] lg:aspect-auto">
            <Image src={entry.image} alt={entry.title} fill sizes="(min-width: 1024px) 44vw, 100vw" className="object-cover opacity-77" />
          ...
          <div className="p-7 lg:p-9">
            ...
            <h2 className="mt-3 font-serif text-3xl">{entry.title}</h2>
