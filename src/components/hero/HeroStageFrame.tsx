...
export function HeroStageFrame({ chamberLabel, chamberNote, children }: HeroStageFrameProps) {
  return (
    <div className="surface-frame relative min-h-[26rem] overflow-hidden rounded-3xl border border-[var(--color-line)] bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.01))] p-7 shadow-[0_34px_96px_rgba(0,0,0,0.5)] lg:min-h-[32rem] lg:p-8">
      ...
      <div className="absolute inset-[16%_16%_20%] rounded-[2.4rem] border border-[rgba(202,188,156,0.14)]/80" />
