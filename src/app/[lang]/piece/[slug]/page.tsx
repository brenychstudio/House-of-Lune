  ...
  return (
    <PageShell dictionary={dictionary} lang={lang}>
      <section className="mx-auto max-w-6xl px-6 py-24 lg:px-10">
        ...
        <h1 className="mt-4 font-serif text-4xl">{dictionary.pages.piece.titlePrefix}: {slug}</h1>
        <p className="mt-4 max-w-2xl text-[var(--color-text-muted)]">{dictionary.pages.piece.description}</p>
      </section>
    </PageShell>
  );
}
